...
Serie A -> Premier League 25/26 (cross-league)       LSTM rich, NO odds    0.3816        0.3884    1.0750 0.6517
```
...
```
                                       experiment      method  accuracy  balanced_acc  log_loss  brier
DB-size: 1 league (Serie A only) -> Serie A 25/26 LSTM (rich)    0.5132        0.4673    0.9973 0.5953
  DB-size: 2 leagues (+ La Liga) -> Serie A 25/26 LSTM (rich)    0.5289        0.4775    0.9935 0.5926
      DB-size: 3 leagues (+ EPL) -> Serie A 25/26 LSTM (rich)    0.5263        0.4715    0.9927 0.5920
```
