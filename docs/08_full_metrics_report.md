...
```
      ...
      Backtest: PoissonElo + ML + RL                 strike vs break-even (binomial)  11/23 wins at avg odds 2.16 (p=1.000)
          ...
          Model quality (test split)                                log-loss / Brier 0.98 / 0.577 vs baselines 1.10 / 0.667
                   ...
                   Transfer: La Liga                             PyTorch NN acc (CI)                       41.6% [0.4, 0.5]
                   Transfer: La Liga            TF hybrid (NN + PoissonElo) acc (CI)                       47.1% [0.4, 0.5]
                   Transfer: La Liga              sklearn Gradient Boosting acc (CI)                       45.5% [0.4, 0.5]
                   Transfer: La Liga            sklearn Logistic Regression acc (CI)                       46.8% [0.4, 0.5]
                   Transfer: La Liga               sklearn Ridge classifier acc (CI)                       47.4% [0.4, 0.5]
                   Transfer: La Liga                  sklearn Random Forest acc (CI)                       43.4% [0.4, 0.5]
            ...
            Transfer: Premier League                             PyTorch NN acc (CI)                       39.2% [0.3, 0.4]
            Transfer: Premier League            TF hybrid (NN + PoissonElo) acc (CI)                       41.3% [0.4, 0.5]
            Transfer: Premier League              sklearn Gradient Boosting acc (CI)                       40.8% [0.4, 0.5]
            Transfer: Premier League            sklearn Logistic Regression acc (CI)                       41.8% [0.4, 0.5]
            Transfer: Premier League               sklearn Ridge classifier acc (CI)                       41.0% [0.4, 0.5]
